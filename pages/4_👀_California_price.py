...
forest_reg = joblib.load("pages/data/forest_reg_model.pkl")
...
x_test = pd.read_csv('pages/data/x_test.csv', header = None, names=column_names)
y_test = pd.read_csv('pages/data/y_test.csv', header = None)
