...
model_architecture = "pages/data/digit_config.json"
model_weights = "pages/data/digit_weight.h5"
...
def app():
    ...
    btn_action = st.button('Lấy dữ liệu')
    if btn_action:
        ...
        cv2.imwrite('pages/data/digit_random.jpg', digit_random)
        image = Image.open('pages/data/digit_random.jpg')
